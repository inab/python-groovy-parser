...
class GroovyRestrictedTokenizer(RegexLexer):
    ...
    tokens = {
        ...
        'base_common': [
            ...
            (r'(class|interface|enum|trait)(\s+)', bygroups(Keyword.Declaration, Whitespace),
             'class'),
            ...
            (r'[0-9](?:_?[0-9]+)*(?:\.[0-9](?:_?[0-9]+)*)?(?:[+-]?[eE][0-9]+)?[FfDdGg]?', Number.Float, 'after_number'),
            ...
            (r'(\.)([a-zA-Z_]\w*)', bygroups(Operator, Name.Attribute), 'after_number'),
